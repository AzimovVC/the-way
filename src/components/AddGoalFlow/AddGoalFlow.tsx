    ...
    const next = dispatch({
      ...
      input: {
        ...
        tasks: tasksForGoal(title.trim(), split ? tasks : [], {
          ...
          // Привычка заведена с другом, и лента не свернёт её в общую строку дня. Ставится здесь,
          // а не когда пара сложится: строка про заведение — про этот день, а ответа на
          // приглашение можно ждать до завтра.
          paired: mate !== null,
        }),
      },
    })
