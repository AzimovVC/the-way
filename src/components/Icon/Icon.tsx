...
const MULTI_PATH = {
  ...
  // Карандаш — «поправить эту строку». Стоит в самой строке привычки, а не в раскрытой панели:
  // правка — самое частое из редких действий, и ради неё не надо раскрывать карточку.
  pencil: [
