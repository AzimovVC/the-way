...
export const SAMPLE_TIER_AWARD: MilestoneAward = {
  ...
  report: {
    ...
    freezesUsed: 1,
    message:
      'Цель, которую ты сам себе поставил: 21 день — Читать. Дошёл. Было 2 срыва и столько же возвращений — и это ничуть не хуже идеального пути: тут важна настойчивость, а не только дисциплина.',
  },
}
