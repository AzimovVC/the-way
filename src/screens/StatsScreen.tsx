        ...
        <PeriodSummaryCard
          ...
          info={
            <MetricInfo title="Золотые дни">
              <p>Золотой день — это когда закрыты все задачи дня. Не часть, а все.</p>
        ...
        <MonthGrid
          info={
            <MetricInfo title="Цвета дней">
              ...
              <p>Жёлтый — сделано всё. Зелёный — часть. Красный — мимо. Фиолетовый — выходной.</p>
        ...
        <section>
          <div className="mb-2 flex items-center gap-2">
            ...
            <MetricInfo title="Проценты у привычек">
              <p>Число справа — сколько закрыто за последние две недели.</p>
