...
create table if not exists public.feed_hearts (
  ...
  -- названной ценой: счёт становится накручиваемым. Отсюда следует, что на экране рисуется не
  -- число, а **лица**: своё лицо среди двух чужих никого не обманывает, а «3» обманывает.
